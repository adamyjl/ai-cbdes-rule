...
class Munkres
{
  ...
  private:
    ...
    {
        for (std::list<std::pair<size_t, size_t>>::const_iterator i = haystack.begin(); i != haystack.end();
             i++)
        {
            if (needle == *i)
            {
    ...
    int step3()
    {
        ...
        Main Zero Search
         ...
         3. If a Z* exists, cover this row and uncover the column of the Z*. Return to Step 3.1 to find a new
        Z
        */
